...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Pocc
...
func (eth *Pocc) startBloomHandlers() {
...
// for the Pocc header bloom filters, permitting blazing fast filtering.
