...
// PeerInfo represents a short summary of the Pocc sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Pocc protocol version negotiated
