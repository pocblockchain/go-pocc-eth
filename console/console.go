...
import (
	...
	"github.com/pocc/go-pocc/internal/jsre"
	"github.com/pocc/go-pocc/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute Pocc requests through
...
// Welcome show summary of current Pocc instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Pocc metadata
	fmt.Fprintf(c.printer, "Welcome to the Pocc JavaScript console!\n\n")
	c.jsre.Run(`
