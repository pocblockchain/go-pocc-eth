...
// Package p2p implements the Pocc p2p network protocols.
package p2p
...
import (
	...
	"github.com/pocc/go-pocc/p2p/nat"
	"github.com/pocc/go-pocc/p2p/netutil"
)
...
func (srv *Server) startListening() error {
	...
	if !laddr.IP.IsLoopback() && srv.NAT != nil {
		srv.loopWG.Add(1)
		go func() {
			nat.Map(srv.NAT, srv.quit, "tcp", laddr.Port, laddr.Port, "pocc p2p")
			srv.loopWG.Done()
		}()
	}
	return nil
