...
// Package types contains data types related to Pocc consensus.
package types
...
import (
	...
	"github.com/pocc/go-pocc/crypto/sha3"
...
// Header represents a block header in the Pocc blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) topoccer.
type Body struct {
	Transactions []*Transaction
	Uncles       []*Header
}

// Block represents an entire block in the Pocc blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Pocc RLP block format.
