...
import (
	...
	"github.com/pocc/go-pocc/common/bitutil"
...
// that address/topic, and binary AND-ing those vectors topoccer.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them topoccer
				var orVector []byte
...
// the reuested retrieval queue to be serviced topoccer with other sessions.
//
