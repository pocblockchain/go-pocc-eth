...
// stateObject represents an Pocc account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of pocc address of the account
	data     Account
	db       *StateDB
...
// Account is the Pocc consensus representation of accounts.
