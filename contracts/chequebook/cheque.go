...
// Package chequebook package wraps the 'chequebook' Pocc smart contract.
//
...
import (
	...
	"github.com/pocc/go-pocc/contracts/chequebook/contract"
	"github.com/pocc/go-pocc/core/types"
	"github.com/pocc/go-pocc/crypto"
	"github.com/pocc/go-pocc/log"
	"github.com/pocc/go-pocc/swarm/services/swap/swap"
)
...
// Cash cashes the cheque by sending an Pocc transaction.
