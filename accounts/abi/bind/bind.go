...
// Package bind generates Pocc contract Go bindings.
//
// Detailed usage document and tutorial available on the go-pocc Wiki page:
// https://github.com/pocc/go-pocc/wiki/Native-DApps:-Go-bindings-to-Pocc-contracts
package bind
