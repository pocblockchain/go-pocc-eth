...
const (
	...
	MessageType_MessageType_PoccGetAddress       MessageType = 56
	MessageType_MessageType_PoccAddress          MessageType = 57
	MessageType_MessageType_PoccSignTx           MessageType = 58
	MessageType_MessageType_PoccTxRequest        MessageType = 59
	MessageType_MessageType_PoccTxAck            MessageType = 60
	...
	MessageType_MessageType_PoccSignMessage      MessageType = 64
	MessageType_MessageType_PoccVerifyMessage    MessageType = 65
	MessageType_MessageType_PoccMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_PoccGetAddress",
	57:  "MessageType_PoccAddress",
	58:  "MessageType_PoccSignTx",
	59:  "MessageType_PoccTxRequest",
	60:  "MessageType_PoccTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_PoccSignMessage",
	65:  "MessageType_PoccVerifyMessage",
	66:  "MessageType_PoccMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_PoccGetAddress":       56,
	"MessageType_PoccAddress":          57,
	"MessageType_PoccSignTx":           58,
	"MessageType_PoccTxRequest":        59,
	"MessageType_PoccTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_PoccSignMessage":      64,
	"MessageType_PoccVerifyMessage":    65,
	"MessageType_PoccMessageSignature": 66,
...
// *
// Request: Ask device for Pocc address corresponding to address_n path
// @next PassphraseRequest
// @next PoccAddress
// @next Failure
type PoccGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *PoccGetAddress) Reset()                    { *m = PoccGetAddress{} }
func (m *PoccGetAddress) String() string            { return proto.CompactTextString(m) }
func (*PoccGetAddress) ProtoMessage()               {}
func (*PoccGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *PoccGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *PoccGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Pocc address derived from device private seed
// @prev PoccGetAddress
type PoccAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *PoccAddress) Reset()                    { *m = PoccAddress{} }
func (m *PoccAddress) String() string            { return proto.CompactTextString(m) }
func (*PoccAddress) ProtoMessage()               {}
func (*PoccAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *PoccAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *PoccSignTx) Reset()                    { *m = PoccSignTx{} }
func (m *PoccSignTx) String() string            { return proto.CompactTextString(m) }
func (*PoccSignTx) ProtoMessage()               {}
func (*PoccSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *PoccSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *PoccSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *PoccSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *PoccSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *PoccSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *PoccSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *PoccSignTx) GetDataLength() uint32 {
...
func (m *PoccSignTx) GetChainId() uint32 {
...
func (m *PoccTxRequest) Reset()                    { *m = PoccTxRequest{} }
func (m *PoccTxRequest) String() string            { return proto.CompactTextString(m) }
func (*PoccTxRequest) ProtoMessage()               {}
func (*PoccTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *PoccTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *PoccTxRequest) GetSignatureV() uint32 {
...
func (m *PoccTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *PoccTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev PoccTxRequest
// @next PoccTxRequest
type PoccTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *PoccTxAck) Reset()                    { *m = PoccTxAck{} }
func (m *PoccTxAck) String() string            { return proto.CompactTextString(m) }
func (*PoccTxAck) ProtoMessage()               {}
func (*PoccTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *PoccTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next PoccMessageSignature
// @next Failure
type PoccSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *PoccSignMessage) Reset()                    { *m = PoccSignMessage{} }
func (m *PoccSignMessage) String() string            { return proto.CompactTextString(m) }
func (*PoccSignMessage) ProtoMessage()               {}
func (*PoccSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *PoccSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *PoccSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
func (m *PoccVerifyMessage) Reset()                    { *m = PoccVerifyMessage{} }
func (m *PoccVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*PoccVerifyMessage) ProtoMessage()               {}
func (*PoccVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *PoccVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *PoccVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *PoccVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev PoccSignMessage
type PoccMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *PoccMessageSignature) Reset()                    { *m = PoccMessageSignature{} }
func (m *PoccMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*PoccMessageSignature) ProtoMessage()               {}
func (*PoccMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *PoccMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *PoccMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*PoccGetAddress)(nil), "PoccGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*PoccAddress)(nil), "PoccAddress")
	...
	proto.RegisterType((*PoccSignTx)(nil), "PoccSignTx")
	proto.RegisterType((*PoccTxRequest)(nil), "PoccTxRequest")
	proto.RegisterType((*PoccTxAck)(nil), "PoccTxAck")
	proto.RegisterType((*PoccSignMessage)(nil), "PoccSignMessage")
	proto.RegisterType((*PoccVerifyMessage)(nil), "PoccVerifyMessage")
	proto.RegisterType((*PoccMessageSignature)(nil), "PoccMessageSignature")
