...
// Package accounts implements high level Pocc account management.
package accounts
...
// Account represents an Pocc account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Pocc account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain pocc.ChainStateReader)
