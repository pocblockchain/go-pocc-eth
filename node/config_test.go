...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "pocc.ipc", false, filepath.Join(os.TempDir(), "pocc.ipc")},
		{"data", "pocc.ipc", false, "data/pocc.ipc"},
		{"data", "./pocc.ipc", false, "./pocc.ipc"},
		{"data", "/pocc.ipc", false, "/pocc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "pocc.ipc", true, `\\.\pipe\pocc.ipc`},
		{"data", "pocc.ipc", true, `\\.\pipe\pocc.ipc`},
		{"data", `\\.\pipe\pocc.ipc`, true, `\\.\pipe\pocc.ipc`},
	}
