...
import (
	...
	"github.com/pocc/go-pocc/common/mclock"
...
// Service implements an Pocc netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Pocc      // Full Pocc service if monitoring a full node
	les    *les.LightPocc // Light Pocc service if monitoring a light node
...
func New(url string, ethServ *eth.Pocc, lesServ *les.LightPocc) (*Service, error) {
...
func (s *Service) login(conn *websocket.Conn) error {
	...
	if info := infos.Protocols["pocc"]; info != nil {
