...
import (
	...
	"github.com/pocc/go-pocc/logger"
	"github.com/pocc/go-pocc/p2p"
	"github.com/pocc/go-pocc/p2p/nat"
	"github.com/pocc/go-pocc/whisper"
)
...
func main() {
	...
	// Create an Pocc peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting Pocc peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start Pocc peer: %v.\n", err)
		os.Exit(1)
	}
