...
import (
	...
	"github.com/pocc/go-pocc/crypto/ecies"
	"github.com/pocc/go-pocc/event/filter"
...
// Whisper represents a dark communication interface through the Pocc
...
// New creates a Whisper client ready to communicate through the Pocc P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
